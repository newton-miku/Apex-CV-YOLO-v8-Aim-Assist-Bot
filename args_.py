...
def arg_init(args):
    ...
    args.add_argument("--Kp", type=float, default=0.379, help="Kp")  # proporcional to distance 0.4 nimble 0.1 slack
    ...
    args.add_argument("--Kd", type=float, default=0.36, help="Kd")  # derivative absorber 0.4 stiff 0.1 soft
